...
<html lang="es">
	<head>
		<meta charset ="utf-8">
		<title> Tabla de Guarderías </title>
...
<?php
 ...
 echo "<nav class='navbar navbar-default'>";
    ...
    echo "<div class='navbar-header'><a class='navbar-brand' >Tabla Guarderias</a></div>";
...
echo "<td>".$objCollector->GuarderiaXCiudad($guarderias->getId())->getNombre()."</td>";    
	...
	echo "<td><a href='eliminar.php?id=".$guarderias->getId()."'>Eliminar</a></td>"; 
	echo "</tr>"; 
